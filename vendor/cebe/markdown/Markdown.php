...
class Markdown extends Parser
{
    ...
    use inline\_Superscript;
    use inline\_Leftsuperscript;
    use inline\_Subscript;
    use inline\_FractionTrait;
    use inline\_SumTrait;
    use inline\_Smaller;
    use inline\_DefinitionTrait;
    use inline\_AbbreviationTrait;
    use inline\_ColorTrait;
